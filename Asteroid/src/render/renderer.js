...
export class Renderer {
  ...
  drawHud(state) {
    ...
    ctx.font = '700 24px "Orbitron", "Rajdhani", sans-serif';
    ctx.fillText(`SCORE ${state.score.toString().padStart(6, '0')}`, 24, 42);

    ctx.fillStyle = '#ffe8c0';
    ctx.font = '700 31px "Orbitron", "Rajdhani", sans-serif';
    ctx.fillText(timeLeft.toFixed(2), 24, 80);

    ctx.fillStyle = '#9ad3ff';
    ctx.font = '600 18px "Orbitron", "Rajdhani", sans-serif';
  ...
  drawFinalCountdown(state) {
    ...
    ctx.font = '800 86px "Orbitron", "Rajdhani", sans-serif';
  ...
  drawEndOverlay(state) {
    ...
    ctx.font = '700 56px "Orbitron", "Rajdhani", sans-serif';
    ...
    ctx.font = '600 24px "Orbitron", "Rajdhani", sans-serif';
